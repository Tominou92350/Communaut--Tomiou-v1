...
Bot.on("guildMemberAdd", member => {
    ...
    Bot.channels.cache.get("id du salon").send("Hey <@" + member.id + "> bievenue sur **Communauté-Tominou**!");
...
Bot.on("guildMemberRemove", member => {
    ...
    Bot.channels.cache.get("id du salon").send("<@" + member.id + "> est partie de Communauté-Tominou!");
});
...
Bot.on("messageCreate", async message => {
    ...
    if (message.content === "!s'abonner à Tominou") {
        ...
        message.member.roles.add("id du rôle");
...
Bot.on("messageCreate", async message => {
    ...
    if (message.content === "!code"){
        ...
        message.member.send("Voici le lien du code du bot Communauté-Tominou:");
